Module FinanceControl
    ...
    Public Function GetWeeklyData(transaction As List(Of InternalTransactionsModel))
        ...
        If Double.IsNaN(WeeksPercentage) OrElse Double.IsInfinity(WeeksPercentage) Then
            WeeksPercentage = 0
        End If
    ...
    Public Function GetMonthlyData(transaction As List(Of InternalTransactionsModel))
        ...
        If Recent = 0 Then
            MonthsPercentage = 100
        Else
            MonthsPercentage = (ThisMonthSales - Recent) / Recent * 100
        End If

         If Double.IsNaN(MonthsPercentage) OrElse Double.IsInfinity(MonthsPercentage) Then
            MonthsPercentage = 0
        End If
