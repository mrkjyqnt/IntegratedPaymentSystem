    ...
    Private Sub Button_Click(sender As Object, e As RoutedEventArgs)
        ...
        If sender Is ButtonEnter Then
            ...
            If SectionChangePassword.Visibility = Visibility.Visible Then
                ...
                If newPassword = "" OrElse reNewPassword = "" Then
                    Message.Show("Error", "Fill <bold>new password</bold> and <bold>repeated new password</bold>")
                    ApplyBlurEffect()
                    Return
                End If
                ...
                result = Message.Confirm("Code Sent", "A code has been sent to your email</newline>please enter it in the box to confirm", code)
                If Not result Then
            ...
            result = Message.Confirm("Success", "In order to apply the account changes, you need to log out.</newline></newline>Press <bold>Enter</bold> to accept")
